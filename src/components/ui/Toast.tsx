...
export default function name({open,setOpen,type,msg}:{open:boolean,setOpen:Function,type:boolean,msg:string}) {
  ...
  <Toast.Root className="min-w-20 w-64 absolute  right-5  flex flex-col bottom-5  bg-white dark:bg-violet-500 rounded-md shadow-black drop-shadow-sm shadow-sm p-2" open={open} onOpenChange={()=>setOpen}>
